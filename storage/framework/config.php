<?php return array (
  ...
  array (
    ...
    'locale' => 'en',
    'fallback_locale' => 'en',
    'key' => 'tl30RvLKuBjSMqSidxKc0i3JwD4Jt6ml',
    'cipher' => 'AES-256-CBC',
    'log' => 'single',
    'providers' => 
    array (
  ...
  array (
    ...
    'compiled' => '/var/www/october/storage/framework/views',
  ),
  '*::database' => 
  array (
    'fetch' => 8,
    ...
    array (
      ...
      array (
        ...
        'database' => 'october',
        'username' => 'root',
        'password' => '6vdPZz_5S?chLq*&82ghK+fwH!E2apYcC7Rg3s9t+A?^JCrwgW',
        'charset' => 'utf8mb4',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/var/www/october/storage/framework/cache',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
